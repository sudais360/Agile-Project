...
def get_random_questions(cursor, count=5):
    query = f"SELECT question, option1, option2, option3, correct_option FROM north_america ORDER BY RAND() LIMIT {count};"
...
def display_story(screen, font):
    ...
    story_lines = [
        "Welcome to the Grand Expedition of North America!"
        "A continent of sprawling landscapes, diverse cultures, and groundbreaking innovations."
        "Your mission, should you choose to accept it,"
        "is to explore North America's majestic landmarks,"
        "answering questions to earn your stripes as a North American Navigator."
        "From the skyscrapers of New York to the natural beauty of the Grand Canyon,"
        "your intellect will be your roadmap."
        "Are you ready to discover the secrets of this vast continent?"
        "Press space to embark on your North American adventure!"
    ]
...
sky_surface = pygame.image.load('city-backgrounds-pixel-art/city 1/10.png').convert()
