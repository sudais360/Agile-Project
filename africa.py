...
def get_random_questions(cursor, count=5):
    query = f"SELECT question, option1, option2, option3, correct_option FROM africa ORDER BY RAND() LIMIT {count};"
...
def display_story(screen, font):
    ...
    story_lines = [
        "Welcome to the Grand Expedition of Africa!"
        "A continent of diverse landscapes, rich history, and unparalleled natural wonders."
        "Your adventure, if you dare to undertake it,"
        "will guide you through Africa's most spectacular sights,"
        "answering questions to earn your stripes as an African Pathfinder."
        "From the pyramids of Egypt to the wildlife of the Serengeti,"
        "your intellect will be your North Star."
        "Are you ready to unravel the mysteries of the cradle of humankind?"
        "Press space to embark on your African odyssey!"
    ]
...
sky_surface = pygame.image.load('city-backgrounds-pixel-art/city 4/9.png').convert()
