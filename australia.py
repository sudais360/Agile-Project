...
def get_random_questions(cursor, count=5):
    query = f"SELECT question, option1, option2, option3, correct_option FROM australia ORDER BY RAND() LIMIT {count};"
...
def display_story(screen, font):
    ...
    story_lines = [
        "Welcome to the Adventurous Outback of Australia!",
        "A land where nature's beauty meets modern cities, a true geographical marvel.",
        "Your mission, if you dare to accept,",
        "is to explore Australia's stunning landscapes and famous landmarks,",
        "answering questions to earn your title as the Aussie Adventurer.",
        "From the Sydney Opera House to the Great Barrier Reef,",
        "your wits and knowledge will guide you.",
        "Are you ready to take on the land Down Under?",
        "Press space to begin your Australian expedition!"
